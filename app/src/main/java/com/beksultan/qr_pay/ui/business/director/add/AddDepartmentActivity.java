...
public class AddDepartmentActivity extends BaseCategoryActivity implements AddDepartmentView {

    @InjectPresenter
    AddDepartmentPresenter mvpPresenter;
                ...
                new AlertDialog.Builder(AddDepartmentActivity.this)
                        ...
                        .setPositiveButton("Да", (dialogInterface, i) ->
                        {
                            CreateParam param = new CreateParam(
                                    head.id,
                                    CompanyPreferences.get().companyId,
                                    edt_departmentName.getText().toString().trim());
                            mvpPresenter.createDepartment(param);
                        })
    ...
    @Override
    public void onCreatedDepartment(String string) {
        if (string.equals("true")) {
            startActivity(new Intent(AddDepartmentActivity.this, DirectorActivity.class));
            finish();
        }
    }
